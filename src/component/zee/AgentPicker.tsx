...
//       <div className="w-full max-w-5xl bg-[#0D0F1E] border border-[#283056] rounded-2xl p-6">
...
//                 whileHover={{ y: -4 }}
//                 whileTap={{ scale: 0.98 }}
//                 onClick={() => (selected ? remove(cub.id) : add(cub))}
...
//                   <Image src={cub.icon} alt={cub.label} width={100} height={100} className="rounded-xl" />
//                   <div>
...
//             <div className="relative w-14 h-14 rounded-xl bg-[#141736] grid place-items-center border border-[#2A2F5E]">
//               <Image src="/images/cubs/cart.png" alt="Cart" width={40} height={40} />
//               <AnimatePresence>
//                 {items.length > 0 && (
//                   <motion.span
//                     initial={{ scale: 0 }}
...
//             <button className="px-4 py-3 rounded-xl bg-gray-700" onClick={clear}>
//               Clear
//             </button>
...
//   onClick={(e) => {
//     e.stopPropagation();        // prevent the click from bubbling to any backdrop
//     setPickerOpen(false);       // close picker
//     setTimeout(() => setFormOpen(true), 0); // open form on next tick
//   }}
...
// // For the “fly to cart” animation state
// type Flying = {
//   key: string;
//   src: string;
...
//   // refs used to calculate animation positions
//   const cartRef = useRef<HTMLDivElement | null>(null);
//   const imgRefs = useRef<Record<string, HTMLImageElement | null>>({});

//   const [flying, setFlying] = useState<Flying[]>([]);

//   // helper: start fly animation then add to cart
...
//   return (
//     <>
//       {/* star background + backdrop */}
//       <Starfield />
//       <div className="fixed inset-0 z-[110] flex items-center justify-center" onClick={() => setPickerOpen(false)}>
//         <div className="absolute inset-0 bg-black/40 backdrop-blur-xs" />
//         <div
//           className="relative z-[120] w-full max-w-5xl bg-[#0D0F1E]/95 border border-[#283056] rounded-2xl p-6"
...
//                   <div className="flex items-center gap-4">
//                     {/* use plain img to easily grab DOM node for fly animation */}
//                     <img
//                       ref={(el) => (imgRefs.current[cub.id] = el)}
//                       src={cub.icon}
//                       alt={cub.label}
//                       className="rounded-xl w-28 h-28 object-contain"   // ← bigger mascots (112px)
//                     />
//                     <div>
//                       <div className="text-xl font-semibold">{cub.label}</div>
//                       <div className="text-sm text-gray-400">{cub.tagline}</div>
